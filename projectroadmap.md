# Project Roadmap – Gift and Date Tracking System

## Sprint 1
- [x] Come up with project topic
- [x] Create GitHub repository
- [x] Edit and Commit changes to README.md file
- [x] Explore existing Python code related to project topic
...
Alerts
- [x] Create a reminder that prints a "1-week warning" for upcoming dates.
- [x] Add a "day-of" reminder for events.
